odoo.define('huroos_delete_invoiceline.form_widgets', function (require) {
	"use strict";
    ...
    var One2manyDelete = FieldOne2Many.extend({
		...
		delete_selected_lines: function()
		{
			...
			var w_response = confirm("Desideri eliminare ?");
			if (w_response) {
                ...
                rpc.query({
                    ...
                    if (current_model === 'account.move.line')

                        {
                            var AccountMoveId = self.recordData['move_id'].res_id;
