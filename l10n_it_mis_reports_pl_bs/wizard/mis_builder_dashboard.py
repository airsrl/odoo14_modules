...
class AddMisReportInstanceDashboard(models.TransientModel):
    ...
    def action_add_to_dashboard(self):
        ...
        self.env.ref("l10n_it_mis_reports_pl_bs.mis_report_instance_result_view_form")
        view = self.env.ref("l10n_it_mis_reports_pl_bs.mis_report_instance_result_view_form")
        report_result = (
