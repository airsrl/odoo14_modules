...
class MisReportInstance(models.Model):
    ...
    def save_report(self):
        ...
        xmlid = "l10n_it_mis_reports_pl_bs.mis_report_instance_view_action"
        action = self.env["ir.actions.act_window"]._for_xml_id(xmlid)
        view = self.env.ref("l10n_it_mis_reports_pl_bs.mis_report_instance_view_form")
    ...
    def preview(self):
        self.ensure_one()
        view_id = self.env.ref("l10n_it_mis_reports_pl_bs." "mis_report_instance_result_view_form")
        return {
    ...
    def print_pdf(self):
        ...
        return (
            self.env.ref("l10n_it_mis_reports_pl_bs.qweb_pdf_export")
    ...
    def export_xls(self):
        ...
        return (
            self.env.ref("l10n_it_mis_reports_pl_bs.xls_export")
            .with_context(**context)
            .report_action(self, data=dict(dummy=True))  # required to propagate context
        )
    ...
    def display_settings(self):
        ...
        view_id = self.env.ref("l10n_it_mis_reports_pl_bs.mis_report_instance_view_form")
        return {
            "type": "ir.actions.act_window",
            "res_model": "mis.report.instance",
