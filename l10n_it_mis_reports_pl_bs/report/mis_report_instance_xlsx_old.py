...
from odoo.addons.l10n_it_mis_reports_pl_bs.models.data_error import DataError
from odoo.addons.l10n_it_mis_reports_pl_bs.models.mis_report_style import TYPE_STR
...
class MisBuilderXlsx(models.AbstractModel):
    _inherit = "report.l10n_it_mis_reports_pl_bs.mis_report_instance_xlsx"
    ...
    def generate_xlsx_report(self, workbook, data, objects):
        ...
        text_dates = "Dal: " + objects[0].date_from.strftime('%d/%m/%Y') + \
                     "      Al: " +objects[0].date_to.strftime('%d/%m/%Y')
        align_center = workbook.add_format({"align": "center"})
        sheet.write(1, 0, text_dates, align_center)
        row_pos += 2
