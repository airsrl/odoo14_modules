...
#from odoo.addons.gls_shipping_integration.models.utils import get_dom_tree, python_2_unicode_compatible
from .utils import get_dom_tree, python_2_unicode_compatible
import json
