    ...
    def get_template_values(self):  # noqa: C901
        ...
        def get_all_taxes(record):
            ...
            for tax_id in tax_ids:
                # if 'IVA' in tax_id.account_id.name:
                #     continue
                ...
                # Il valore viene riassegnato perchè non gestisce l'arrotondamento decimale
                imponibile = tax_id.price_total / (tax_line_id.amount / 100)

                # FIX PER IMPONIBILE NON CORRETTO
                move_line_with_this_tax = record.line_ids.filtered(
                    lambda l: tax_line_id in l.tax_ids and not l.tax_line_id
                )
                imponibile = sum(ln.price_subtotal for ln in move_line_with_this_tax)
            ...
            for line in record.invoice_line_ids:
                if line.display_type in ("line_section", "line_note"):
                    ...
                    continue
                if line.tax_ids and line.tax_line_id:
                    continue
